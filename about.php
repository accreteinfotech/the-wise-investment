        ...
        <section id="funfacts" class="section-4 odd counter funfacts" style="padding-top:50px;">
            <div class="container">
                <div class="row text-center intro">
                    <div class="col-12">
                        <h2>Figure Facts</h2>
                        <p class="text-max-800">Over the years we have done many things that we are proud of! Assets that top the number race are the constant motivation provider to perform extraordinary !</p>
                    </div>
                </div>
