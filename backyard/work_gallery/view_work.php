...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Works</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Works</h4>
										...
										<?php
											...
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><?php echo $cat['work_name']; ?></a></td>
														<td style="text-align:center;"><a href="view_work_gallery.php?pid=<?php echo $cat['work_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/eye.png"></a></td>
