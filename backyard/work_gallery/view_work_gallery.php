...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Work Gallery</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Work Gallery</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from work_gallery where work_id=?",array($_GET['pid']));
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><img style="height:100px;width:100px;" src="../images/work_gallery_image/<?php echo $cat['work_gallery_image']; ?>"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="delete_work_gallery.php?cid=<?php echo $cat['work_gallery_id'];?>&aid=<?php echo $cat['work_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
