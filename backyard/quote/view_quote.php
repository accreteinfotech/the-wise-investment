...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Quote</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Quote</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from quote");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
													    <td><?php echo $cat['quote_id']; ?></td>
													<?php
															if($cat['quote_active']==0)
															{
															?>
																	<td><a href="active.php?pid=<?php echo $cat['quote_id'];?>" class="btn btn-neutral" style="background-color:#FF0000;color:#ffffff;">In Process</a></td>
													...
													?>
														...
														<td><?php echo $cat['quote_email']; ?></td>
														<td><?php echo $cat['quote_phone']; ?></td>
														<td><?php echo $cat['product_name']; ?></td>
														<td><?php echo $cat['quote_qty']; ?></td>
