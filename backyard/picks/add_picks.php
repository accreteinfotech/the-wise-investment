...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Picks</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add Picks</h4>
                                   
                                    <form action="insert_picks.php" id="formsubmit" onsubmit="return myfunn1();" name="f1"  method="post" enctype="multipart/form-data">
										<div class="form-group">
                                            <label for="exampleInputName1">Picks Name</label>
                                            <input type="text" class="form-control" id="picks_name" name="picks_name" placeholder="Picks Name">
											<div><span id="s2" style="color:red;"></span></div>
									    </div>
									    <div class="form-group">
                                            <label>Picks Description</label>
                                            <textarea  class="ckeditor" rows="10" id="ckeExample" name="picks_description"></textarea>
											<div><span id="s5" style="color:red;"></span></div>
                                        </div>
									    <div class="form-group">
                                            <label for="exampleInputName1">Picks Website</label>
                                            <input type="text" class="form-control" id="picks_website" name="picks_website" placeholder="Picks Website">
									    </div>
										
                                        <div class="form-group">
                                            <label>Picks Image ( size: 370 X 200 px )</label>
                                            <input type="file" class="form-control" name="picks_image" id="picks_image" >
