...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Pickss</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Picks</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from picks");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><?php echo $cat['picks_name']; ?></td>
                                                        <td><?php echo $cat['picks_website']; ?></td>
													<td><img style="height:70px;width:100px;" src="../images/picks_image/<?php echo $cat['picks_image']; ?>"></td>
														<td><?php  echo substr( $cat['picks_description'],0); ?></td>
													
														
													<td><a href="Edit-Picks/<?php echo $cat['picks_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Picks/<?php echo $cat['picks_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
