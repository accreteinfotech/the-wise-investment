...
<body>
    ...
    ******* Page Wrapper Area Start **********
											...
											<select name="category_id" id="category_id"  class="form-control" >
												<?php
													...
													if($link->count > 0)
													{
														...
														{
															?>
															<option value="<?php echo $type['category_id']; ?>" <?php if($type['category_id']==$category_id){ echo "selected"; } ?>><?php echo $type['category_name']; ?>><?php echo $type['category_name']; ?></option>
															<?php
														}
													}
													else
    ...
    color: #dc3545;"></span>
										...
										<div class="form-group">
                                            <label for="exampleInputName1">Product Weigh</label>
											<input type="text" value="<?php echo $ad['product_weight']; ?>" name="product_weight" placeholder="Enter weight" class="form-control" id="product_total_qty">
									    </div>
										<div class="form-group">
