...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View KgRate</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Kg Rate</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
										...
										<?php
											...
											$sql=$link->rawQuery("select * from kg_rate kg,countries c where kg.country_id=c.id");
                                            //echo $country_id;
											if($sql)
											{
												...
												foreach($sql as $cat)
												{
													...
													<tr>
                                                        ...
                                                        <td><?php echo $cat['rate']; ?></td>
														<td><a  href="edit_kgrate.php?cid=<?php echo $cat['kg_rate_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
														<td><a onClick='javascript:confirmationDelete($(this));return false;' href="delete_kgrate.php?cid=<?php echo $cat['kg_rate_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
