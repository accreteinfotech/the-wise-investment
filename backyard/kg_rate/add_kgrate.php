...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Kg Rate</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add Kg Rate</h4>
                                   <form action="insert_kgrate.php" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
