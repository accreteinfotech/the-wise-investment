...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | Add Work</title>
    ...
    ******* Page Wrapper Area Start **********
                       ...
                       <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="Insert-Work" onsubmit="return myfunn1();" name="f1" id="formsubmit" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Work Name</label>
                                            <input type="text" class="form-control" id="work_name" name="work_name" placeholder="Work Name">
											<div><span id="s1" style="color:red;"></span></div>
									    </div>
										<div class="form-group">
                                            <label for="exampleInputName1">Work Alias</label>
                                            <input type="text" onkeyup="aliascheck(this.value);" class="form-control" id="work_alias" name="work_alias" placeholder="Work Alias">
    ...
    color: #dc3545;"></span>
										 ...
										 <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="work_image" id="work_image">
		...
		$( document ).ready( function () {
			$( "#formsubmit" ).validate( {
				...
				messages: {
					...
					work_image: "Please select work icon",
