...
<head>
    ...
    <!-- Title -->
    <title><?php echo $project_name; ?> | View Work</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-2">View Work List</h4>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
										<?php
											$sql=$link->rawQuery("select * from work");
											if($sql)
											{
												foreach($sql as $cat)
												{
													?>
													<tr>
														<td><?php echo $cat['work_name']; ?></td>
														<td><?php echo $cat['work_alias']; ?></td>
														<td><img style="height:100px;width:100px;" src="../images/work_image/<?php echo $cat['work_image']; ?>"></td>
														
													<td><a href="Edit-Work/<?php echo $cat['work_id']; ?>"><img style="height: 30px;width: 30px;"  src="../img/edit.png"></a></td>
													<td><a onClick='javascript:confirmationDelete($(this));return false;' href="Delete-Work/<?php echo $cat['work_id'];?>"><img style="height: 30px;width: 30px;"  src="../img/delete.png"></a></td>
